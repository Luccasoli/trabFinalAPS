...
/**
 * Resourceful controller for interacting with produtoscompras
 */
class ProdutosCompraController {
  ...
  /**
   * Render a form to be used for creating a new produtoscompra.
   * GET produtoscompras/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
  ...
  /**
   * Render a form to update an existing produtoscompra.
   * GET produtoscompras/:id/edit
   *
   * @param {object} ctx
   * @param {Request} ctx.request
   * @param {Response} ctx.response
