...
/**
 * Resourceful controller for interacting with tapiocas
 */
class TapiocaController {
  /**
   * Show a list of all tapiocas.
   * GET tapiocas
   *
   * @param {object} ctx
  ...
  /**
   * Render a form to be used for creating a new tapioca.
   * GET tapiocas/create
   *
   * @param {object} ctx
   * @param {Request} ctx.request
